...
export declare type ISO6391 = string;
...
export declare enum AddressRestrictionType {
...
export declare enum AffiliateApplicationStatuses {
    APPROVED = "APPROVED",
    PENDING = "PENDING",
    REJECTED = "REJECTED",
...
export interface LiquidityProviderRewardsV2ResponseObject extends LiquidityProviderRewardsResponseObject {
